...
Cleaned up docs/operations by moving old sprint plans, launch logs, and assessments to docs/archive/operations.
Consolidated all archive operations onto the epic/archive-docs branch for final sign-off.
Categorized and moved all loose files in docs/archive root to their respective subdirectories.
